...
| [**warehouse-navigator/**](warehouse-navigator/) | **Навигация по складу** «доведи до товара» без GPS: QR-якоря + AR/PDR (компас-гиро фьюжн, шаг по Вайнбергу, отсев магнитных аномалий, map-matching по плану). Мобильный **APK** + **ПК-клиент** (Qt) + LAN-сервер; только склад/ячейки/товар/навигатор. | TS-ядро (zero-deps) · Node LAN-сервер · Expo RN · Qt6/C++ | ✅ ядро 80/80 · сервер 12/12 · mobile typecheck · Qt собирается |
